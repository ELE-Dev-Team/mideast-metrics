...
export default function TopThreeCountries({ topThreeData, selectedCountryData, showSelectedCountry, selectedMetric, currentYear }) {
    ...
    return (
        <div className="flex flex-col p-5 mt-4 bg-gray-800 rounded-lg shadow-lg text-white w-full max-w-5xl mx-auto border-2 border-green-600">
                    ...
                    <tbody className="bg-gray-800 divide-y divide-gray-700">
                        ...
                        {showSelectedCountry && selectedCountryData && (
                            <tr className="bg-green-700">
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{selectedCountryRank}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-green-300 font-bold">{selectedCountryData.country}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-green-300 font-bold">{selectedCountryData.val}</td>
                            </tr>
                        )}
                    </tbody>
                </table>
